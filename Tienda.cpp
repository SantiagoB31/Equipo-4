...
void Tienda::cambiarHorarioEmpleado() {
    int idEmpleado;
    string nuevoHorario;
    ...
    for (Empleado& empleado : empleados) {
        if (empleado.id == idEmpleado) {
            ...
            getline(cin, nuevoHorario);
            empleado.cambiarHorario(nuevoHorario);
            cout << "Horario actualizado correctamente." << endl;
            return;
        }
    }
...
void Tienda::despedirEmpleado() {
    ...
    for (size_t i = 0; i < empleados.size(); i++) {
        if (empleados[i].id == idEmpleado) {
            ...
            cout << "Empleado despedido correctamente." << endl;
            return;
        }
    }
    cout << "Empleado no encontrado." << endl;
            ...
            if (producto.cantidad >= cantidad) {
                ...
                for (Cliente& cliente : clientes) {
                    if (cliente.nombre == nombreCliente) {
                        ...
                        cliente.agregarFactura(facturas.back().idFactura);
